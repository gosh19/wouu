...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a class=" flex justify-center" href="{{ route('home') }}">
            <img class="h-16" src="{{ asset('images/Logo-2.png') }}" alt="">
        </a>
            ...
            <form wire:submit.prevent="authenticate">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="email" id="email" name="email" type="email" required autofocus class="appearance-none block w-full px-3 py-2 border rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('email') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
                    </div>
