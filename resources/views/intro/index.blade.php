...
@section('body')
    ...
    <div class="mb-10">
        ...
        <div class="flex justify-center mx-3 text-white text-sm md:text-xl text-center ">
            <a class="mr-10 bg-gradient-to-r from-pink-600 to-purple-600 py-2 px-6 rounded-xl shadow-2xl" href="">BUSCAR PROFESIONAL</a>
